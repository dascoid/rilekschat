...
import authV2LoginIllustrationDark from '@images/pages/auth-v2-register-illustration-bordered-dark.png'
import authV2LoginIllustrationLight from '@images/pages/auth-v2-register-illustration-bordered-light.png'
