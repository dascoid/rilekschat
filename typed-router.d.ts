...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'apps-broadcast-list': RouteRecordInfo<'apps-broadcast-list', '/apps/broadcast/list', Record<never, never>, Record<never, never>>,
    'apps-broadcast-view-uuid': RouteRecordInfo<'apps-broadcast-view-uuid', '/apps/broadcast/view/:uuid', { uuid: ParamValue<true> }, { uuid: ParamValue<false> }>,
    ...
    'apps-chat-ori': RouteRecordInfo<'apps-chat-ori', '/apps/chat_ori', Record<never, never>, Record<never, never>>,
    'apps-contacts-list': RouteRecordInfo<'apps-contacts-list', '/apps/contacts/list', Record<never, never>, Record<never, never>>,
    'apps-contacts-view-uuid': RouteRecordInfo<'apps-contacts-view-uuid', '/apps/contacts/view/:uuid', { uuid: ParamValue<true> }, { uuid: ParamValue<false> }>,
    ...
    'apps-import-list': RouteRecordInfo<'apps-import-list', '/apps/import/list', Record<never, never>, Record<never, never>>,
    ...
    'apps-receiver-list': RouteRecordInfo<'apps-receiver-list', '/apps/receiver/list', Record<never, never>, Record<never, never>>,
    'apps-roles': RouteRecordInfo<'apps-roles', '/apps/roles', Record<never, never>, Record<never, never>>,
    'apps-template-list': RouteRecordInfo<'apps-template-list', '/apps/template/list', Record<never, never>, Record<never, never>>,
    'apps-user-list': RouteRecordInfo<'apps-user-list', '/apps/user/list', Record<never, never>, Record<never, never>>,
    'apps-user-list-index-ori': RouteRecordInfo<'apps-user-list-index-ori', '/apps/user/list/index_ori', Record<never, never>, Record<never, never>>,
    'apps-user-view-id-ori': RouteRecordInfo<'apps-user-view-id-ori', '/apps/user/view/:id()ori', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apps-user-view-uuid': RouteRecordInfo<'apps-user-view-uuid', '/apps/user/view/:uuid', { uuid: ParamValue<true> }, { uuid: ParamValue<false> }>,
    'apps-whatsapp-uuid': RouteRecordInfo<'apps-whatsapp-uuid', '/apps/whatsapp/:uuid', { uuid: ParamValue<true> }, { uuid: ParamValue<false> }>,
    'apps-whatsapp-whatsapp': RouteRecordInfo<'apps-whatsapp-whatsapp', '/apps/whatsapp/whatsapp', Record<never, never>, Record<never, never>>,
    ...
    'dashboards-crm-ori': RouteRecordInfo<'dashboards-crm-ori', '/dashboards/crm-ori', Record<never, never>, Record<never, never>>,
    ...
    'pages-company-settings-tab': RouteRecordInfo<'pages-company-settings-tab', '/pages/company-settings/:tab', { tab: ParamValue<true> }, { tab: ParamValue<false> }>,
    ...
    'reset-password-uuid': RouteRecordInfo<'reset-password-uuid', '/reset-password/:uuid', { uuid: ParamValue<true> }, { uuid: ParamValue<false> }>,
    ...
    'term-of-service': RouteRecordInfo<'term-of-service', '/term-of-service', Record<never, never>, Record<never, never>>,
